          ...
          <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center rounded-lg p-6">
            ...
            {isHost && (
              <div className="flex gap-4">
                <button onClick={() => hostRef.current?.handleMessage('host', { type: 'ADD_AI' })} className="bg-green-600 text-white px-8 py-3 rounded-lg text-xl font-bold hover:bg-green-700 transition">
                  添加AI
                </button>
